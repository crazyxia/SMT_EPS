...
export const programInfo = (state) => {
  return state.programInfo;
};
export const programPage = (state) => {
...
export const operationPage = (state) => {
  return state.operationPage;
};
...
export const lineAllDayData = (state) => {
  return state.lineAllDayData;
};
