...
public class DisplayController implements Initializable {
	...
	private void showResult(Integer result) {
		...
		case 0:
			typeLb.setStyle(
					"-fx-background-color:red;-fx-alignment:center;-fx-font-size:140px;-fx-text-fill:white;-fx-font-family:'Microsoft YaHei';");
			resultLb.setStyle(
					"-fx-background-color:red;-fx-alignment:center;-fx-font-size:140px;-fx-text-fill:white;-fx-font-family:'Microsoft YaHei'");
		...
		case 1:
			typeLb.setStyle(
					"-fx-background-color:green;-fx-alignment:center;-fx-font-size:140px;-fx-text-fill:white;-fx-font-family:'Microsoft YaHei'");
			resultLb.setStyle(
					"-fx-background-color:green;-fx-alignment:center;-fx-font-size:140px;-fx-text-fill:white;-fx-font-family:'Microsoft YaHei'");
		...
		case 4:
			typeLb.setStyle(
					"-fx-background-color:purple;-fx-alignment:center;-fx-font-size:140px;-fx-text-fill:white;-fx-font-family:'Microsoft YaHei'");
			resultLb.setStyle(
					"-fx-background-color:purple;-fx-alignment:center;-fx-font-size:140px;-fx-text-fill:white;-fx-font-family:'Microsoft YaHei'");
			typeLb.setText("已换料");
